...
class UserTypesScreen extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Sign Up / Sign In As a",textAlign: TextAlign.start,
                  style: TextStyle(
                    fontSize: 15,
  ...
  Widget _vendorButton(context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          setUserVendor(true);
          print("vendor button is pressed");
  ...
  Widget _customerButton(context) {
    return SizedBox(
      height: 50,
      width: 300,
      child: ElevatedButton(
