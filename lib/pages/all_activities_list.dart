...
class AllActivitiesList extends StatefulWidget {
  const AllActivitiesList({Key? key,}) : super(key: key);


  @override
  _AllActivitiesListState createState() => _AllActivitiesListState();
}

class _AllActivitiesListState extends State<AllActivitiesList> {
  ...
  getCategory()async{
    ...
    print("All Vendors by Department data ===========->>> ${response}");
    var deptData = responseData['content'];
    List dataCat = [];
    List addCatData = [];
      ...
      ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Container(
              ...
              child:InkWell(
                onTap: () {
                  print('tapped on activity id ==>> ${activityList[index]['id']}');
